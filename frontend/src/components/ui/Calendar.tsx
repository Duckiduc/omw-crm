  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "relative border border-input bg-background hover:bg-accent hover:text-accent-foreground rounded-md px-3 py-2 text-sm focus-within:border-ring focus-within:ring-ring/50 focus-within:ring-2 cursor-pointer",
        ...
        caption_label: cn(
          "select-none font-medium text-sm flex items-center gap-1",
          captionLayout === "dropdown" &&
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "h-8 w-8 p-0 font-normal border-0",
